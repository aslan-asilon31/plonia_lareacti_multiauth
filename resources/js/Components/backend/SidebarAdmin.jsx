         ...
         <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
          <div className="app-brand demo">
            <a href="index.html" className="app-brand-link">
              ...
              <span className="app-brand-text demo menu-text fw-bolder ms-2">Plonia</span>
            </a>
          ...
          <ul className="menu-inner py-1">
            ...
            <li className="menu-item " >
              <a href="/package" className="menu-link ">
                <i className="menu-icon tf-icons bx bx-checkbox-checked"></i>
                <div data-i18n="Analytics">Package Detail</div>
              </a>
            </li>
