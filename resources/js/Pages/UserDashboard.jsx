...
import image2 from "@/assets/backend/img/illustrations/man-with-laptop-light-user.png"

import SidebarUser from '../Components/backend/SidebarUser'
                    ...
                    <div className="d-flex align-items-end row">
                      <div className="col-sm-7 mb-20">
                        <div className="card-body">
                          ...
                          <p className="mb-4 ">
                            <span className="ukuran1">You are login as</span>  <a className="fw-bold " style={{ fontSize:"40px" }}>  User</a> 
                          </p>
