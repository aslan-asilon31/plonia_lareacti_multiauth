...
import image2 from "@/assets/backend/img/illustrations/man-with-laptop-light-admin.png"
                    ...
                    <div className="d-flex align-items-end row">
                      <div className="col-sm-7">
                        <div className="card-body">
                          <h5 className="card-title text-primary">Welcome   <a style={{ fontSize:"30px" }}> <b>{auth.user.name}! 🎉</b> </a></h5>
                          <p className="mb-4 ">
                            <span className="ukuran1">You are login as</span>  <a className="fw-bold " style={{ fontSize:"30px" }}>  {auth.user.role}</a> 
                          </p>
